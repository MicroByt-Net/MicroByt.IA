...
public interface IToolChainRegistry
{
    ...
    /// <param name="arguments">Argumentos parseados proporcionados por el LLM.</param>
    /// <param name="ct">Token de cancelación.</param>
    /// <returns>Resultado de la ejecución como cadena.</returns>
    Task<string> ExecuteAsync(string toolName, JsonDocument arguments, CancellationToken ct = default);
}